...
DCODE_HOME_DIR="${DCODE_HOME:-$HOME/.dcode}"
STANDALONE_ROOT="$DCODE_HOME_DIR/packages/standalone"
...
validate_package() {
  ...
  [ -x "$package_dir/bin/codex" ] || die "package does not contain bin/codex runtime"
