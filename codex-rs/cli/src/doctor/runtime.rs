//! Captures how this DCode process was launched.
//!
...
/// Builds the process provenance row for the current DCode executable.
///
...
pub(super) fn search_check() -> DoctorCheck {
    ...
    if status != CheckStatus::Ok {
        check = check.remediation("Install ripgrep or repair the bundled DCode package.");
    }
    check
}
