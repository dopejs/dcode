...
#[derive(Debug, Parser)]
#[command(bin_name = "dcode plugin marketplace")]
...
enum MarketplaceSubcommand {
    ...
    /// List plugin marketplaces DCode is currently considering and their roots.
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "dcode plugin marketplace add",
    after_help = "Examples:\n  dcode plugin marketplace add ./path/to/marketplace\n  dcode plugin marketplace add owner/repo --ref main\n  dcode plugin marketplace add https://github.com/owner/repo --sparse plugins/foo"
)]
...
#[derive(Debug, Parser)]
#[command(bin_name = "dcode plugin marketplace list")]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "dcode plugin marketplace upgrade",
    after_help = "Examples:\n  dcode plugin marketplace upgrade\n  dcode plugin marketplace upgrade debug"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "dcode plugin marketplace remove",
    after_help = "Example:\n  dcode plugin marketplace remove debug"
)]
