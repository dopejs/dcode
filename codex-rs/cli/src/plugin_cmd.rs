...
#[derive(Debug, Parser)]
#[command(
    bin_name = "dcode plugin add",
    after_help = "Examples:\n  dcode plugin add sample@debug\n  dcode plugin add sample --marketplace debug"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "dcode plugin list",
    after_help = "Examples:\n  dcode plugin list\n  dcode plugin list --marketplace debug\n  dcode plugin list --json\n  dcode plugin list --available --json"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "dcode plugin remove",
    after_help = "Examples:\n  dcode plugin remove sample@debug\n  dcode plugin remove sample --marketplace debug"
)]
