...
impl SlashCommand {
    ...
    pub fn description(self) -> &'static str {
        match self {
            ...
            SlashCommand::Init => "create an AGENTS.md file with instructions for DCode",
            ...
            SlashCommand::Quit | SlashCommand::Exit => "exit DCode",
            SlashCommand::Copy => "copy last response as markdown",
            SlashCommand::Raw => "toggle raw scrollback mode for copy-friendly terminal selection",
            SlashCommand::Diff => "show git diff (including untracked files)",
            SlashCommand::Mention => "mention a file",
            SlashCommand::Skills => "use skills to improve how DCode performs specific tasks",
            ...
            SlashCommand::Personality => "choose a communication style for DCode",
            ...
            SlashCommand::Permissions => "choose what DCode is allowed to do",
            ...
            SlashCommand::Login => "log in to DeepSeek with an API key",
            SlashCommand::Logout => "log out of DCode",
