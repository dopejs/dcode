...
//! "leave the old title alone" or "clear the title DCode last wrote".
...
pub(crate) enum SetTerminalTitleResult {
    ...
    /// the title DCode manages, or some other fallback.
    NoVisibleContent,
}
...
/// or a previous program may have set before DCode started managing the title.
